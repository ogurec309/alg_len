...
Program lab_7;
  ...
  begin {lab 7}
    ...
    writeln('└────────────┴────────────┴───────────┘');
		...
		WriteLn(Chr(217));}
		writeln;
		writeln('введите число n меньше 10(размер фигуры должен быть больше 0)');
		read(n);
		while n>9  do
    begin
      writeln('n должно быть меньше 10 и больше 0, пожалуйста введите n в диапазоне от 1 до 9');
      read(n);
    end;
